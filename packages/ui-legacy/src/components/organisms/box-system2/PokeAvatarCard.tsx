...
import type { CompactPokemon, PokeTypeId } from '@supeffective/dataset'
    ...
    return (
      ...
      >
        ...
        {pokemon && opts.types && (
          ...
          >
            {pokemon.type1 && (
              <TypeIcon title={typeTitle} typeId={pokemon.type1 as PokeTypeId} filled colored size="xs" />
            )}
            {pokemon.type2 && (
              <TypeIcon title={typeTitle} typeId={pokemon.type2 as PokeTypeId} filled colored size="xs" />
            )}
          </span>
        )}
        {pokemon && opts.name && (
