...
import { PokeImgFile, TypeIcon } from '@/v1/components/molecules'
    ...
    >
      ...
      {opt.types && (
        <div className={classes.infoTypes}>
          {poke.type1 && <TypeIcon typeId={poke.type1} colored size="xs" />}
          {poke.type2 && <TypeIcon typeId={poke.type2} colored size="xs" />}
        </div>
      )}
